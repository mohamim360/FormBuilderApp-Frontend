...
import { Template, Form, Question, Answer } from '../types/types'; // Adjust the import path as needed
...
export default function TemplateResponses() {
  ...
  const getAnswerForQuestion = (form: Form, questionId: string): string | number | boolean | null => {
    const answer = form.answers.find((a: Answer) => a.questionId === questionId);
                                ...
                                {answer !== null ? (
                                  <>
                                    {question.type === 'CHECKBOX' ? (
                                      <Badge
                                        bg={answer === 'Yes' ? 'success' : 'secondary'}
                                      >
                                        {String(answer)}
                                      </Badge>
                                    ) : (
